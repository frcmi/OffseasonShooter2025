 ...
 */
public class XboxControllerSim extends XboxController implements Sendable {
     ...
     */
    public XboxControllerSim(final int port) {
        super(port);
     ...
     *
     * @param threshold the minimum axis value for the returned {@link BooleanEvent} to be true.
     *     This value should be in the range [0, 1] where 0 is the unpressed state of the axis.
     ...
     *
     * @param loop the event loop instance to attach the event to.
     * @return an event instance representing the left bumper button's digital signal attached to
     *     the given loop.
     */
     ...
     *
     * @param loop the event loop instance to attach the event to.
     * @return an event instance representing the right stick button's digital signal attached to
     *     the given loop.
     */
