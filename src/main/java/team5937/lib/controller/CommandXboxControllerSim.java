package team5937.lib.controller;
...
public class CommandXboxControllerSim extends CommandXboxController {
    private final XboxControllerSim m_hid;
     ...
     */
    public CommandXboxControllerSim(int port) {
        super(port);
        m_hid = new XboxControllerSim(port);
    }
     ...
     */
    @Override
    public XboxControllerSim getHID() {
        return m_hid;
    }
    ...
    public Trigger a(EventLoop loop) {
        return button(XboxControllerSim.Button.kA.value, loop);
    }
    ...
    public Trigger b(EventLoop loop) {
        return button(XboxControllerSim.Button.kB.value, loop);
    }
    ...
    public Trigger x(EventLoop loop) {
        return button(XboxControllerSim.Button.kX.value, loop);
    }
    ...
    public Trigger y(EventLoop loop) {
        return button(XboxControllerSim.Button.kY.value, loop);
    }
    ...
    public Trigger leftBumper(EventLoop loop) {
        return button(XboxControllerSim.Button.kLeftBumper.value, loop);
    }
    ...
    public Trigger rightBumper(EventLoop loop) {
        return button(XboxControllerSim.Button.kRightBumper.value, loop);
    }
    ...
    public Trigger back(EventLoop loop) {
        return button(XboxControllerSim.Button.kBack.value, loop);
    }
    ...
    public Trigger start(EventLoop loop) {
        return button(XboxControllerSim.Button.kStart.value, loop);
    }
    ...
    public Trigger leftStick(EventLoop loop) {
        return button(XboxControllerSim.Button.kLeftStick.value, loop);
    }
    ...
    public Trigger rightStick(EventLoop loop) {
        return button(XboxControllerSim.Button.kRightStick.value, loop);
    }
    ...
    public Trigger leftTrigger(double threshold, EventLoop loop) {
        return axisGreaterThan(XboxControllerSim.Axis.kLeftTrigger.value, threshold, loop);
    }
    ...
    public Trigger rightTrigger(double threshold, EventLoop loop) {
        return axisGreaterThan(XboxControllerSim.Axis.kRightTrigger.value, threshold, loop);
    }
