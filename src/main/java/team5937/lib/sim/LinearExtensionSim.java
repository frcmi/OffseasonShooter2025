...
public class LinearExtensionSim extends LinearSystemSim<N2, N1, N2> {
    ...
    private final Optional<Supplier<Rotation2d>> m_angle;
     ...
     * @param angle Whether gravity should be simulated or not and at what angle.
     * @param startingHeightMeters The starting height of the elevator.
     * @param measurementStdDevs The standard deviations of the measurements. Can be omitted if no
     *     noise is desired. If present must have 1 element for position.
     */
    @SuppressWarnings("this-escape")
    public LinearExtensionSim(
            LinearSystem<N2, N1, N2> plant,
            DCMotor gearbox,
            double minHeightMeters,
            double maxHeightMeters,
            Optional<Supplier<Rotation2d>> angle,
    ...
    public final void setState(double positionMeters, double velocityMetersPerSecond) {
        setState(
                VecBuilder.fill(
                        MathUtil.clamp(positionMeters, m_minHeight, m_maxHeight),
