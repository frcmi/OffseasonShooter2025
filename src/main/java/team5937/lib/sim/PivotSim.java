...
public class PivotSim extends LinearSystemSim<N2, N1, N2> {
     ...
     * @param realAngleFromSubsystemAngleZero Whether gravity should be simulated or not and at what
     *     angle.
    ...
    public PivotSim(
            ...
            double minAngleRads,
            double maxAngleRads,
            Optional<Supplier<Rotation2d>> realAngleFromSubsystemAngleZero,
     ...
     */
    public static MomentOfInertia estimateMOI(Distance length, Mass mass) {
        return KilogramSquareMeters.of(
                1.0 / 3.0 * mass.in(Kilograms) * length.in(Meters) * length.in(Meters));
    }
                            ...
                            if (m_realAngleFromSubsystemAngleZero.isPresent()) {
                                double alphaGrav =
                                        3.0
                                                ...
                                                * Math.cos(
                                                        x.get(0, 0)
                                                                + (m_realAngleFromSubsystemAngleZero
                                                                                .get()
                                                                                .get()
                                                                                .getRadians()
                                                                        - Math.PI / 2.0))
