...
public class Robot extends LoggedRobot {
    ...
    public Robot() {
        ...
        try {
            ...
            watchdog.setTimeout(RobotConstants.kLoopOverrunWarningTimeout);
        } catch (Exception e) {
            DriverStation.reportWarning("Failed to disable loop overrun warnings.", false);
        }
        CommandScheduler.getInstance().setPeriod(RobotConstants.kLoopOverrunWarningTimeout);
